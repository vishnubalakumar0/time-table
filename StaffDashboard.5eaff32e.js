...
function StaffDashboard({ user, onLogout }) {
    _s();
    const [timetableData, setTimetableData] = (0, _react.useState)(null);
    const [loading, setLoading] = (0, _react.useState)(true);
    (0, _react.useEffect)(()=>{
        const fetchTimetable = async ()=>{
            try {
                const ttSnap = await (0, _firestore.getDocs)((0, _firestore.collection)((0, _firebase.db), 'timetable'));
                if (!ttSnap.empty) {
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                ...
                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                    ...
                    children: [
                        ...
                        user && user.name && /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
                            className: "greeting",
                            children: [
                                "\uD83D\uDC4B Welcome, ",
                                user.name
...
_s(StaffDashboard, "mDjcqKp5HFZah11wuLq2030djNc=");
_c = StaffDashboard;
var _c;
...
},{"react/jsx-dev-runtime":"dVPUn","react":"jMk1U","./AnimatedBackground":"8BTPX","./StaffTimetableGrid":"fc4Yr","../utils/pdfUtils":"jSko5","../utils/firebase":"5V7se","firebase/firestore":"3RBs1","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi"}],"fc4Yr":[function(require,module,exports,__globalThis) {
