...
},{"react/jsx-dev-runtime":"dVPUn","react":"jMk1U","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi","./Toast":"jptcB","./HoursTracker":"k2NcG","./timetableGrid":"90aaK","./StaffTimetableGrid":"fc4Yr","../utils/pdfUtils":"jSko5","../utils/timetableGenerator":"7lXFL","../utils/firebase":"5V7se","firebase/auth":"4ZBbi","firebase/firestore":"3RBs1","./AnimatedBackground":"8BTPX"}],"jptcB":[function(require,module,exports,__globalThis) {
        ...
        this.classes.forEach((cls)=>{
            if (cls && cls.name) {
                ...
                this.DAYS.forEach((day)=>{
                    this.classDailyLabCount[cls.name][day] = 0;
                });
            }
        });
  ...
  \u{1F4C5} ${day}:`);
                for(let period = 0; period < this.PERIODS; period++){
                    ...
                    if (period > 0) {
                        ...
                        if (prevSlot && prevSlot.isLabContinuation) {
                            ...
                            if (labSubject && labSubject.currentBlockRemaining > 0) {
                                ...
                                if (this.teacherBusySlots[tName]?.[slotKey]) console.log(`    P${period + 1}: Teacher ${tName} busy, cannot continue lab block`);
                                else {
                    ...
                    if (bestSubject) {
                        ...
                        if (isLabStart) {
                            ...
                            if (!teacherFreeForBlock) console.log(`    P${period + 1}: Cannot start lab, teacher busy in block`);
                            else {
    ...
    _findBestSubjectForSlot(className, dayIdx, period, classSubjects) {
        ...
        for (const subject of classSubjects){
            ...
            const tSettings = this.staffSettings[subject.teacher] || {
                freePeriodMode: 'auto',
                manualFreePeriods: 0
            };
            ...
            } else // Auto: prefer leaving one free period per day when possible
    ...
    _placeAt(className, dayIdx, period, subject, isLabContinuation = false) {
        ...
        if (subject.isContinuous && isLabContinuation) this.classDailyLabCount[className][day] = (this.classDailyLabCount[className][day] || 0) + 1;
    }
    ...
    _validateFinal() {
        ...
        Object.keys(expectedTeacherHours).forEach((t)=>{
            ...
            if (actual !== expected) warnings.push(`${t}: expected ${expected} hours, scheduled ${actual}`);
        });
        return {
