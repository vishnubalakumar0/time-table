...
function AdminDashboard({ user, onLogout }) {
    _s();
    const [classes, setClasses] = (0, _react.useState)((0, _storage.Storage).get('classes') || []);
    const [staff, setStaff] = (0, _react.useState)((0, _storage.Storage).get('staff') || []);
    const [subjects, setSubjects] = (0, _react.useState)((0, _storage.Storage).get('subjects') || []);
    const [timetable, setTimetable] = (0, _react.useState)((0, _storage.Storage).get('timetable'));
    ...
    const addClass = ()=>{
        ...
        setClasses(updated);
        (0, _storage.Storage).set('classes', updated);
        setNewClass({
            name: ''
        });
    ...
    const addStaff = async ()=>{
        ...
        setStaff(updated);
        (0, _storage.Storage).set('staff', updated);
        // 3️⃣ Reset form
        setNewStaff({
            name: '',
            username: '',
    ...
    const addSubject = ()=>{
        ...
        setSubjects(updated);
        (0, _storage.Storage).set('subjects', updated);
        setNewSubject({
            className: '',
            name: '',
            subjectType: '',
    ...
    const generateTimetable = ()=>{
        ...
        if (result.success) {
            ...
            (0, _storage.Storage).set('timetable', timetableData);
                                    ...
                                    classes.length === 0 ? /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("p", {
                                        ...
                                        children: [
                                                ...
                                                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("table", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("tbody", {
                                                            children: classes.map((cls, idx)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("tr", {
                                                                    children: [
                                            ...
                                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                                ...
                                                children: classes.map((cls, idx)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
...
_s(AdminDashboard, "e+VZy0S4RfMr1U7XBaUpQKjdQD0=");
_c = AdminDashboard;
var _c;
...
},{"react/jsx-dev-runtime":"dVPUn","react":"jMk1U","./AnimatedBackground":"8BTPX","./Toast":"jptcB","./HoursTracker":"k2NcG","./TimetableGrid":"5VElg","./StaffTimetableGrid":"fc4Yr","../utils/storage":"2BjnI","../utils/timetableGenerator":"fTr1F","../utils/pdfUtils":"jSko5","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi","firebase/auth":"4ZBbi","firebase/firestore":"3RBs1","../utils/firebase":"5V7se"}],"jptcB":[function(require,module,exports,__globalThis) {
